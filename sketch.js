...
switch(gameState)
{
   case 0:
      ...
      invisblock1.x = width/9;
      invisblock1.y = height/0.952;
      invisblock2.x = width/1.37;
      invisblock2.y = height/1.09;
      invisblock3.x = width/1.111;
      invisblock3.y = height/1.3;
      protagonist.scale = 0.4
   ...
   case 1:
     ...
     case 2:
      ...
      invisblock1.x=width/2
      invisblock1.y=height/100
      invisblock1.visible =false
      invisblock2.x=width/2
      invisblock2.y=height/100
      invisblock3.x=width/2
      invisblock3.y=height/100
      ...
      if(protagonist.y > height/0.8)
      {
         gameState+=5;
         
   
      platform4.y=height-2000
      platform4.x=width-2000
      platform4.visible = true
      platform4.scale = 0.6
      

      platform5.y=height-2000
      platform5.x=width-2000
      platform5.visible = true
      platform5.scale = 1.5

      platform6.y=height-2000
      platform6.x=width-2000
      platform6.visible = true
      platform6.scale = 0.5
     

      platform7.y=height-2000
      platform7.x=width-2000
      platform7.visible = true
      platform7.scale = 0.3

      platform8.y=height-2000
      platform8.x=width-2000
      platform8.visible = true
      platform8.scale = 0.2

      platform9.y=height-2000
      platform9.x=width-2000
      platform9.visible = true
      platform9.scale = 0.1

      platform10.y=height-2000
      platform10.x=width-2000
      platform10.visible = true
      platform10.scale = 1.5
     ...
     {
        gameState+=4;
        platform1.y=height-2000
        platform1.x=width-2000
        platform1.visible = true
        platform1.scale = 0.7
  
        platform2.y=height-2000
        platform2.x=width-2000
        platform2.visible = true
        platform2.scale = 1.0
       
        platform3.y=height-2000
        platform3.x=width-2000
        platform3.visible = true
        platform3.scale = 0.8
     ...
     case 5:
      ...
      case 7:
         ...
         fill("White")
         textSize(30)
         text ("You Died, so bad.",width/2,height/2)
         text ("Press ENTER to Respawn",width/2,height/1.8)
         

         if(keyIsDown(13))
         {
            protagonist.y=height/100;
            protagonist.x=width/2;
            gameState-=7;
         }
         break;
